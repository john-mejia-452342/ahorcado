        ...
        <div class="container-game">
            ...
            <div class="container-letras-ahorcado">
                <ul id="horizontal-list">
                    <button v-for="(item, index) in palabra_escrita" :key="index" type="button" class="btn btn-success">
...
function generarAleatorio() {
    ...
    game.value = true
    aleatorio.value = Math.floor(Math.random() * animales.value.length)
    for (let i = 0; i < animales.value[aleatorio.value].length; i++) {
...
function palabra_generada() {
    return animales.value[aleatorio.value]
}
