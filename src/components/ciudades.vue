...
function generarAleatorio() {
  ...
  game.value = true
  aleatorio.value = Math.floor(Math.random()*ciudades.value.length)
  for (let i = 0; i < ciudades.value[aleatorio.value].length; i++) {
...
function palabra_generada(){
  return ciudades.value[aleatorio.value]
}
